...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "fixed right-4 z-80 flex h-[54px] w-[54px] items-center justify-center rounded-full bg-zup-green text-white shadow-[0_10px_26px_rgba(31,168,85,.4)] transition-[transform,background-color] duration-200 hover:scale-105 hover:bg-zup-green-dark md:bottom-6",
